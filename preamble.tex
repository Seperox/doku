...
\usepackage{pdfpages} % Include pdfs: \includepdf[pages={1}]{myfile.pdf}, pages={-} for all pages
...
\newminted{http}{bgcolor=tango-bg,frame=lines,framesep=2mm,samepage=true,fontsize=\footnotesize}
