...
\begin{description}
	...
	innerhalb seiner Entität beschreiben. Folgende Liste von Attribute ist nicht
	vollständig, sondern eine Auswahl wie sie für diese Arbeit relevant ist,
	weggelassen wurden, \texttt{media, supplemental, tagVersion, versionScheme}.
	\begin{description*}
	...
	\item[Entity] Beschreibt die Organisation die für diesen SWID Tag verantwortlich ist. In einem Tag können theoretisch beliebig viele 
\end{description}

\subsection{Probleme}
Bei der Analyse und der Implementation des ISO Standard 19770-2:2014, sind einige Ungereimtheiten aufgefallen. 
