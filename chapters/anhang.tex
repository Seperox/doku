...
\includepdf[scale=.8,pages={-},pagecommand=\section{SWID Measurement Endpoint REST Manual}\label{REST:swid-measurement-manual}]{other_documents/swid-measurement-manual.pdf}
