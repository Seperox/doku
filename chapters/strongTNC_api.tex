...
\subsubsection{Empfehlung} Falls sich der HTTP Signatures Draft zu einem Standard durchsetzt empfehlen wir deren Implementation mit zusätzlicher Verwendung von TLS. Obwohl HTTP Signatures ohne TLS verwendet werden können, weist das HTTP Protokoll verschiedene Verletzlichkeiten\cite{httpsecconsiderations2014} auf, die durch TLS berücksichtigt werden.
