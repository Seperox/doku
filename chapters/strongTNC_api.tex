...
Serverseitig werden die Model-Serialisierer durch das DynamicFieldsMixin erweitert. Dieses extrahiert vor dem serialisieren die Parameter aus dem Request und übergibt sie dem Serialisierer (\ref{api:tagserializer}). Das Mixin ist vollständig entkoppelt von der Serialisierer Implementierung und kann für alle Serialisierer verwendet werden.
