...
\begin{description}
\item [swid\_entities] Ein SWID Tag kann mehrere Entities enthalten. Entities haben in einem Tag eine Rollen oder eine beliebige Kombination aus (Tag creator, Publisher oder Licensor). Pro SWID Tag darf es aber nur einen Tag creator geben. Dieser Constraint wird aber erst in den Models vom \gls{ORM} angewandt. 
