...
Nachfolgend so Beispielhaft die konkrete umsetzung der HTTP Kommunikation mit dem swid-measurement Endpoint aufgezeigt werden.

\begin{description}
\item[Schritt 1: Übermitteln von Software-IDs]asdfasdf \\
