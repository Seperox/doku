...
Methoden in einer Klasse geschrieben werden. Um die Assertions zu definieren,
...
Unerstützung für Plugins.

Nachfoglend das selbe Minimalbeispiel wie in Listing
\ref{improvements:unittest-beispiel}, diesmal mit Pytest:
...
Falls mehrere Tests auf die selben Daten zugreifen, kann man natürlich wie bei
...
Pytest bietet hier als Abhilfe parametrisierte Tests. Dabei wird mithilfe eines
...
Unsere Test Suite (siehe Absatz \ref{improvements:tests}) automatisiert
...
Fehlerfall wird der Autor des entspechenden Commits per E-Mail benachrichtigt.
