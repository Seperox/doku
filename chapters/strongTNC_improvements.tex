...
entkoppelt und kann mittels einer Art Strategie (\enquote{Strategy
Pattern}\cite{gamma1994design}) festgelegt werden.
...
Die enge Kopplung von strongSwan und strongTNC, durch eine gemeinsam genutzten
...
unterstützt. Problematisch ist auch, dass SQLite nicht mehrenuzerfähig ist.
