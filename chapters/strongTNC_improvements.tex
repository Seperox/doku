...
Bei der Architektur der Pagingkomponente wurde darauf geachtet, dass sie einfach wiederverwendet werden kann. Der Inhalt, der seitenweise ausgeliefert werden soll, wurde völlig vom Paging entkoppelt und kann mittels Strategy (Strategy Pattern \cite{gamma1994design}) festgelegt werden.
